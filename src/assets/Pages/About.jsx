        ...
        <h1 className="section-title-category">О нас</h1>
          <div className="about-grid">
            <div className="about-info">
              ...
              <div className="about-info-text">
                <p>
                  История Табыс Строй началась с небольшого магазина строительных материалов. За 5 лет мы выросли в крупнейший строительный магазин региона с площадью более 2000 м² и собственным складским комплексом.
                </p>
                <img src={tabys} alt="Табыс Строй" className="about-image-mobile" />
                <p>
          ...
          <div className="about-cards">
            <div className="about-card">
              ...
              <p className='text'>В нашем магазине представлен широкий выбор строительных и отделочных материалов: цемент, кирпич, блоки, пиломатериалы, сухие смеси, краски и многое другое.</p>
            </div>
            <div className="about-card">
            ...
            <div className="about-card">
              ...
              <p className='text'>Мы работаем как с частными клиентами, так и с компаниями. Для постоянных клиентов действует система скидок и специальные условия на оптовые закупки.</p>
            </div>
          </div>
        </div>
      </div>
